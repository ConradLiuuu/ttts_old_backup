...
{
  ros::init(argc, argv, "flycapture_HSV_reconfigure_right");
  ros::NodeHandle nh;
  image_transport::ImageTransport it(nh);
  image_transport::Publisher pub_img = it.advertise("origin_right",1);
  image_transport::Publisher pub_bin = it.advertise("binary_right",1);
